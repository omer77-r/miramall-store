...
export const products: Product[] = [
  ...
  },
  {
    ...
    descriptionAr: "أمن دارك بـ 110 درهم فقط! 🔒 هاد المصباح الشمسي الذكي على شكل كاميرا مراقبة واقعي 100%، كايخلي أي واحد يفكر بلي عندك كاميرا حقيقية. الإضاءة قوية وتخدم بالطاقة الشمسية كاملة — مكتخلص حتى درهم كهرباء. ساهل فالتثبيت، حطو قدام الدار ولا فالجردة و ارقد مرتاح. حل ذكي وغير مكلف باش تحمي دارك وأسرتك.",
    price: 110,
    originalPrice: 200,
    discount: 45,
