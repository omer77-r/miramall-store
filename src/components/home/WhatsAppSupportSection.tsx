...
export default function WhatsAppSupportSection() {
  ...
  const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent("السلام عليكم، عندي سؤال بخصوص منتجات ندية")}`;
  ...
  return (
    <>
      ...
      {/* Floating WhatsApp button - bottom-left for RTL */}
      <motion.div
      ...
      >
        ...
        >
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center w-14 h-14 rounded-full bg-emerald-500 text-white shadow-xl shadow-emerald-300/40 hover:bg-emerald-600 transition-colors"
